...
# FILENAME: CNN 
# SPECIFICATION: 
# Complete the Python program (cnn.py) that will train a Convolutional Neural Network
...
def load_digit_images_from_folder(folder_path, image_size=(32, 32)):
    ...
    for filename in os.listdir(folder_path):
        ...
        img = Image.open(os.path.join(folder_path,
        filename)).convert('L').resize(image_size)
        # Adding the converted image to the feature matrix and label to the class
        # vector
